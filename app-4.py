...
# ══════════════════════════════════════════════════════════════════════════════
# STEP 1 — CAMP TYPE  (native Streamlit radio — actually switches state)
# ══════════════════════════════════════════════════════════════════════════════
camp_type = st.radio(
    "Camp type",
    options=['KIDS', 'YTH'],
...
# ── Visual camp type indicator (radio widget above is the real selector) ───────
st.markdown(f"""
<div style="margin-bottom:.3rem;font-family:{_font};font-size:.6rem;font-weight:700;
     letter-spacing:2px;text-transform:uppercase;color:#6B7A99;">
  Select camp type ↑ then configure below
</div>
<div class="camp-tabs">
  <div class="camp-tab-pill {'kids-tab' if not _is_yth else ''}">🏕&#65039; KIDS Camp</div>
  <div class="camp-tab-pill {'yth-tab' if _is_yth else ''}">✝&#65039; YTH Camp</div>
</div>
""", unsafe_allow_html=True)
